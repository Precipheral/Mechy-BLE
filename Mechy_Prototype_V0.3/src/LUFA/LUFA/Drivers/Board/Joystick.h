...
#define __JOYSTICK_H__
	...
	/* Includes: */
		...
		#include "lufa/Drivers/Peripheral/ADC.h"
			...
			#define JOY_X			ADC_GetChannelReading(ADC_REFERENCE_AVCC | ADC_RIGHT_ADJUSTED | ADC_CHANNEL1 )
			#define JOY_Y			ADC_GetChannelReading(ADC_REFERENCE_AVCC | ADC_RIGHT_ADJUSTED | ADC_CHANNEL0 )
			...
			{
				return (uint8_t)(0); //(~PINF & JOY_MASK);
			}
