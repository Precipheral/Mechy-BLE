...
#define __BUTTONS_H__
	...
	/* Includes: */
		#include "../../Common/Common.h"
		...
		#if (BOARD == BOARD_NONE)
			//Bit masks for buttons, moving 1 into the port byte to select pin ie. (1 << 0) = pin 0  
			#define BUTTONS_MASK	(BUTTONS_BUTTON1 | BUTTONS_BUTTON2 | BUTTONS_BUTTON3 | BUTTONS_BUTTON4 | BUTTONS_BUTTON5 | BUTTONS_BUTTON6 | BUTTONS_BUTTON7 | BUTTONS_BUTTON8)
			#define BUTTONS_BUTTON1  (1 << 5)	// Bottom Left 
			#define BUTTONS_BUTTON2  (1 << 7)	// Bottom Right
			#define BUTTONS_BUTTON3  (1 << 4)	// Top Left
			#define BUTTONS_BUTTON4  (1 << 6)	// Top Right
			#define BUTTONS_BUTTON5  (1 << 0)	// UP
			#define BUTTONS_BUTTON6  (1 << 1)	// Down
			#define BUTTONS_BUTTON7  (1 << 2)	// Left 
			#define BUTTONS_BUTTON8  (1 << 3)	// Right
			...
			static inline void       Buttons_Init(void) 
			{
				...
				PORTD |=  BUTTONS_MASK;
				/*					
				DDRD  &= ~BUTTONS_BUTTON2;
				PORTD |=  BUTTONS_BUTTON2;
				
				DDRD  &= ~BUTTONS_BUTTON3;
				PORTD |=  BUTTONS_BUTTON3;
				
				DDRD  &= ~BUTTONS_BUTTON4;
			...
			{
				//Pins must always be set to input to protect from over current.
				DDRD  &= ~BUTTONS_MASK;
				PORTD |=  BUTTONS_MASK;
				/*
				DDRD  &= ~BUTTONS_BUTTON2;
